<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:61:"/home/vagrant/Code/output/public/../app/view/login/index.html";i:1584339588;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="utf-8">
                ...
                <form method="post" role="form" id="login" class="login-form fade-in-effect">
                    ...
                    <div class="login-header">
                        <a href="dashboard-1.html" class="logo">
                            <span style="color: #fff;font-size:16px;">FEIBU WMS</span>
                            <span>登录中心</span>
                        </a>
